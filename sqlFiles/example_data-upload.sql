...
language sql as 
$procedure$
insert into author (id,display_name,email_address,"password", date_created)
values
...
;
insert into story (id, author_id, title, date_created)
values
...
;
insert into segment (id, author_id, story_id, content, segment_status_id, previous_segment_id, date_created)
values 
...
(11, 8, 4, $$Not that I was any different bck when I was a  boy. Frankly, I wasn't the kind of kid who had to be forbidden from going up to Highborough, nor the kind who would humour a dare sending him up there (not that I had many of the kind of friends who would even try, clock_timestamp()),. $$, 4, 4, clock_timestamp()),
...
(16, 9, 4, $$It's probably not surprising$$, 4, 4, clock_timestamp()),
